...
export const LUBOV_BEZ_BOLKA_CONFIG = {
  ...
  // SEO
  SEO: {
    TITLE: 'Любов без болка | Онлайн програма на Милена Петрова',
    DESCRIPTION: 'Онлайн програма за жени, които искат да разпознаят болезнените модели във връзките, да спрат да губят себе си и да започнат да избират любов без болка.',
