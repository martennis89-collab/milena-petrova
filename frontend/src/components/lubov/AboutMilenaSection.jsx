      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-5 gap-12 items-start">
          ...
          <div className="md:col-span-3 space-y-6 text-[#4A4A4A] leading-relaxed text-lg">
            ...
            <p>
              В живота си тя е преминала през трудно детство, ранен брак, майчинство, болезнен развод, голяма промяна и продължителна токсична връзка, в която постепенно е започнала да губи усещането за себе си.
            </p>
