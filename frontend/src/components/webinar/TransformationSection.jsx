...
const TransformationSection = () => {
  const oldMe = [
    "Повтаряш едни и същи грешки във връзките",
    "Чувстваш се безпомощна и не разбираш защо се случва отново",
    "Обвиняваш себе си или партньора, но нищо не се променя",
  ...
  const newMe = [
    ...
    "Разбираш по-дълбоката причина зад изборите си",
    "Поемаш отговорност за промяната без самообвинение",
    "Имаш яснота и сила да избереш различно",
    "Знаеш откъде започва истинската промяна"
  ];
      ...
      <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 style={{ fontFamily: "'Playfair Display', serif" }} className="text-3xl sm:text-4xl bg-gradient-to-r from-[#B85C7A] to-[#D4758C] bg-clip-text text-transparent mb-4 font-bold">
            Какво може да се промени, когато видиш модела ясно
          </h2>
          <p className="text-lg text-[#9B7680]">
            60 минути, които могат да променят перспективата ти
          </p>
        </div>
